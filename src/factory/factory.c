...
#define RESETME    "/mnt/factory-reset.now"
...
int main(int argc, char *argv[])
{
	...
	if (yes || yorn("Factory reset device, restores /etc, /home, and /var, (y/N)? ")) {
		printf("Preparing system for factory reset on next boot ... ");
		touch(RESETME);
		printf("Done.\n");
